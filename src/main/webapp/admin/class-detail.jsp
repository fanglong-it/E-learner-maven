                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="my-3">
                            ...
                            <p>
                                Max student: ${clazz.maxStudent}
                            </p>
                            <p>
                                Status: ${clazz.status}
                            </p>
                            <p>
                                Created at: ${clazz.dateCreate}
                            </p>
                            <p>
                            ...
                            <div class="modal fade" id="updateCourseModel" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form class="" action="${pageContext.request.contextPath}/admin/class-detail"
                                              method="post">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="maxStudent"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="teacherId">
                                                        <c:forEach var="tea" items="${teachers}">
                                                            <option value="${tea.id}"  ${tea.id==clazz.account.id ? 'selected': ''}>${tea.fullname}-${tea.username}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <c:forEach var="registration" items="${registrations}" varStatus="counter">
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-primary">${registration.requestStatus}</span>
                                    </td>
