                                            ...
                                            <c:forEach var="c" items="${requestScope.classes}" varStatus="counter">     
                                                <tr>
                                                    ...
                                                    <td class="d-flex gx-3">
                                                        <button type="button" class="btn btn-warning me-2 d-inline-block" data-bs-toggle="modal" data-bs-target="#updateModal-${counter.count}">
                                                            Update
                                                        </button>
                                                        <!-- Update -->
                                                                    ...
                                                                    <form action="manager-class" method="post">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select class="form-select" name="teacherId" id="teacher-select">
                                                                ...
                                                                <div class="modal-content">
                                                                    <form action="assignTeacher" method="post">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="form-group  mt-3 mb-3">
                                                                                <label for="teacher-asign">Select Teacher</label>
                                                                                <select class="form-select" name="teacherId" id="teacher-asign">
                                                                                    <option selected="" value="${c.account.id}">${c.account.fullname}-${c.account.username}</option>
                                                                                    <c:forEach var="tea" items="${requestScope.accounts}">
                                                                                        <option value="${tea.id}">${tea.fullname}-${tea.username}</option>
                                                                                    </c:forEach>
