			...
			<div class="col-sm-10">
				...
				<div class="card">
					<div class="card-body">
						...
						<img src="images/${requestScope.course.image}" width="80%"
							height="50%" alt="alt">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<img width="50px" height="50px"
									src="images/${requestScope.course.account.avatar}" alt="..." />
								<a class="btn btn-link"
									href="detail-teacher?accountId=${requestScope.course.account.id}">View
									Detail Teacher</a>
							</div>
						</div>
						<div class="row">
												...
												<div class="modal-body">
													<div class="form-group">
														<input type="hidden" value="${requestScope.course.id}"
															name="courseId"> <select id="class"
															class="form-select" name="selectedClassId">
						...
						<ul class="list-group card-body">
							<c:forEach var="l" items="${requestScope.lessons}">
								<li class="list-group-item"><a
									href="learn-lesson?lessonId=${l.id}">${l.lessonName}</a></li>
							</c:forEach>
