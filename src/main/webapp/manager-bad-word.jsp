                        ...
                        <div class="modal-content">
                            <form action="manager-bad-word" method="post">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Add Bad Word</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="lessonName">Bad Word</label>
                                        <input type="text" class="form-control" value="" min="5" id="lessonName"
                                               name="txtBadWord">
                                    </div>
                    ...
                    <form method="GET" action="manager-bad-word">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-success" href="manager-bad-word?id=${c.id}">Delete</a>
                            </td>
                        </tr>
                    </form>
                </c:forEach>
