											...
											<div class="modal-body">
												<div class="form-group">
													<label>Class Name</label> <input class="form-control"
														type="text" name="className" value="">
												</div>
												<div class="form-group">
													<label>Max Student</label> <input class="form-control"
														type="text" name="maxStudent" value="">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label>Course</label> <input class="form-control"
														type="hidden" name="courseId"
														value="${requestScope.course.id}"> <input
										...
										<c:forEach var="c" items="${requestScope.classes}"
											...
											<tr>
												...
												<td class="d-flex gx-3">
													<button type="button"
														class="btn btn-warning me-2 d-inline-block"
														data-bs-toggle="modal"
														data-bs-target="#updateModal-${counter.count}">
														Update</button> <!-- Update -->
													<div class="modal fade" id="updateModal-${counter.count}"
																	...
																	<div class="modal-body">
																		<div class="form-group">
																			...
																			<input class="form-control" type="hidden"
																				name="classId" value="${c.id}">
																		</div>
																		<div class="form-group">
																			<label>Max Student</label> <input
																				class="form-control" type="text" name="maxStudent"
																				value="${c.maxStudent}">
																		</div>
																		<div class="form-group">
																			<label>Image</label> <input class="form-control"
																		...
																		<div class="form-group">
																			<label for="teacher-select">User</label> <select
																				class="form-select" name="teacherId"
																				id="teacher-select">
																		...
																		<div class="form-group">
																			<label>Course</label> <input class="form-control"
																				type="hidden" name="courseId" value="${c.course.id}">
																	...
																	<div class="modal-body">
																		<div class="form-group mt-3 mb-3">
																			<label>Class Name</label> <input type="text"
																				readonly="" value="${c.className}"
																				class="form-control"> <input type="hidden"
																				readonly="" name="classId" value="${c.id}"
																				class="form-control">
																		</div>
																		<div class="form-group  mt-3 mb-3">
																			<label for="teacher-asign">Select Teacher</label> <select
																				class="form-select" name="teacherId"
																				id="teacher-asign">
																				<option selected="" value="${c.account.id}">${c.account.fullname}-${c.account.username}</option>
																				<c:forEach var="tea"
